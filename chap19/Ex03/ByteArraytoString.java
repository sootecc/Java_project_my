...
public class ByteArraytoString {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] array2 = "땡큐".getBytes(Charset.defaultCharset());	//땡큐 -> byte 변환해서 배열에 저장
		byte[] array3 = "베리".getBytes(Charset.forName("MS949"));	//예외 발생: 실행시  예외
		byte[] array4 = "땡큐".getBytes("UTF-8");	//예외처리 필요 : 일반 예외(컴파일시 예외 발생)
		...
		// new String () : byte[] => String으로 변환 		byte -> 문자로 변환
		...
		//3. 한글이 깨지는 경우 : 내보내는 인코딩 타입과 가져오는 인코딩 타입이 불일치 할 경우 깨진다.
